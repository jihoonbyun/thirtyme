package com.example.jb.thirtyme.Main;
...
private List<Item> contents;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("contentview", "1111111111111111");
        ...
        recyclerView.setAdapter(new RecyclerMainViewAdapter(contents, new RecyclerViewOnItemClickListener() {
            @Override
